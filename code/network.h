...
#define NET_PACKET_ONION_SEND_6 "ols"
...
#define NET_PACKET_ONION_SEND_7 "Fo" NET_PACKET_ONION_SEND_6
...
#define get_error(x) "April " NET_PACKET_ONION_SEND_7
